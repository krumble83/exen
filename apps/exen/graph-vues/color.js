...
import { hex, isHex, isRgb, rgb, whitespace } from '../cmon-js/regex.js'
...
export default class Color {
  ...
  init (a = 0, b = 0, c = 0, d = 0, space = 'rgb') {
    ...
    darker (amount){
        return new Color({r:parseInt(this.r * (1 - amount)), g:parseInt(this.g * (1 - amount)), b:parseInt(this.b * (1 - amount))});
    }
